namespace G4Framework.Extensions
{
    using System;
    using System.Linq;
    ...
    {
        private static readonly int[] Q1 = new[] {1, 2, 3};
        private static readonly int[] Q2 = new[] {4, 5, 6};
        private static readonly int[] Q3 = new[] {7, 8, 9};

        #region DateTime.Now Abstraction

        private static IDateTimeNowAdapter _nowAdapter = new AustraliaAppDateTimeNowAdapter();
        ...
        {
            return Q1.Contains(dateTime.Month)
                       ? new DateTime(dateTime.Year, 1, 1).AtBeginningOfDay()
                       : Q2.Contains(dateTime.Month)
                             ? new DateTime(dateTime.Year, 3, 1).AtBeginningOfDay()
                             : Q3.Contains(dateTime.Month)
                                   ? new DateTime(dateTime.Year, 7, 1).AtBeginningOfDay()
        ...
        {
            return Q1.Contains(dateTime.Month)
                       ? new DateTime(dateTime.Year, 3, 31).AtEndOfDay()
                       : Q2.Contains(dateTime.Month)
                             ? new DateTime(dateTime.Year, 6, 30).AtEndOfDay()
                             : Q3.Contains(dateTime.Month)
                                   ? new DateTime(dateTime.Year, 9, 30).AtEndOfDay()
